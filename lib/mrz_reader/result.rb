module MrzReader
  class Result
    ...
    def valid_birth_date?
      @_valid_birth_date ||= calculate_check_digit(@birth_date).to_s == @birth_date_check_digit
    end

    def valid_expiration_date?
      @_valid_expiration_date ||= calculate_check_digit(@expiration_date).to_s == @expiration_date_check_digit
    end

    def valid_document_number?
      @_valid_document_number ||= calculate_check_digit(@document_number).to_s == @document_number_check_digit
    end
    ...
    def calculate_check_digit(sequence)
